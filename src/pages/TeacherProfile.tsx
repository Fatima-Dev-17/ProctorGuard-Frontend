...
const TeacherProfile: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!storedUserId || storedRole !== 'teacher') {
      navigate('/login');
      return;
    }
      ...
      <div className="profile-content">
        ...
        <div className="profile-card">
          ...
          <div className="statistics-section">
            <h2 className="section-title">Teaching Statistics</h2>
            ...
            <div className="stats-grid">
              <div className="stat-item">
                ...
                <div className="stat-details">
                  ...
                  <span className="stat-number">{profile?.statistics?.totalCourses || 0}</span>
                </div>
              </div>
              ...
              <div className="stat-item">
                ...
                <div className="stat-details">
                  ...
                  <span className="stat-number">{profile?.statistics?.totalEvaluations || 0}</span>
                </div>
              </div>
              ...
              <div className="stat-item">
                ...
                <div className="stat-details">
                  ...
                  <span className="stat-number">{profile?.statistics?.totalStudents || 0}</span>
                </div>
              </div>
            </div>
          </div>
